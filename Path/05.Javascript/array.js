...
let names = ["John", "Emma", "Michael", "Sophia", "Daniel"]

const includesEmma = names.includes("Emma");

const indexEmma = names.indexOf("Emma");

console.log(`this is Includes ${includesEmma} and this is the index of Emma ${indexEmma}`);
...
let numbers1 = [2, 3, 4];
numbers1.unshift(1);
console.log(`Added the unshift: ${numbers1} in which the index will be ${numbers1.indexOf(1)}`); // Output: [1, 2, 3, 4]
...
console.log(`Is Identical object in array ${employee.includes(obj3)}`);
console.log(`Is same objct in array: ${employee.includes(obj1)}`);

// const employee = employees.find(employee => employee.name === "John Doe");
// console.log(employee);

// const employeeIndex = employees.findIndex(employee => employee.name === "John Doe");
// console.log(employeeIndex);

let identicalEmployee = {
    name: "John Doe",
    age: 30,
    position: "Developer"
};

console.log(identicalEmployee);
